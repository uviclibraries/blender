...
4. Next at the top left of the Shader Editor choose "Add" and then "Texture" and lastly "Image Texture". A window will pop up attached to your curser. Left click in the shader editor to place it down anywhere.
